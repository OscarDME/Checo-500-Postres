...
export const copy = {
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "📖", title: "Snadné postupy krok za krokem" },
    ],
  },

  samples: {
    kicker: "Malá ochutnávka",
    headline: "NEUVĚŘITELNĚ LAHODNÉ DEZERTY (ZDRAVÁ VERZE):",
  ...
  moreRecipesCta: {
    ...
    ctaLabel: "ZÍSKAT MOJI KNIHU HNED",
  },
  ...
  testimonials: {
    ...
    items: [
      ...
      {
        text: "Nechápala som, ako to může být tak dobré bez mléka a cukru. Bezlaktozový dort Tres leches mi vyrazil dech 🤯 Už tři dny peču v kuse.",
        time: "11:47",
      },
      {
  ...
  categories: {
    ...
    groups: [
      ...
      {
        title: "100 moderních dezertů",
        items: [
          { src: "/preview/1-7.webp", alt: "Moderní dezert 1" },
          { src: "/preview/2-6.webp", alt: "Moderní dezert 2" },
          { src: "/preview/3-5-1.webp", alt: "Moderní dezert 3" },
          { src: "/preview/4-3.webp", alt: "Moderní dezert 4" },
        ],
      },
      {
  ...
  bonuses: {
    ...
    items: [
      ...
      },
      {
        ...
        name: "RECEPTY NA ZDRAVÉ KOBLIHY",
        desc: "Chrumkavé kousky bez výčitek, zdravé a plné chuti v každém soustu.",
        price: "499 Kč",
        freeLabel: "DNES ZDARMA",
  ...
  delivery: {
    ...
    items: [
      ...
      { icon: "✅", text: "Můžeš si je prohlížet i na tabletu." },
  ...
  guarantee: {
    kicker: "Bez rizika",
    headline: "VYZKOUŠEJ BEZ RIZIKA — 14denní bezpodmínečná záruka.",
    body: "Máš 14 dní na to, abys vše v klidu vyzkoušela. Pokud tě recepty nepřesvědčí, vrátím ti peníze do posledního haléře. Bez zbytečných otázek. Bez stresu.",
    alt: "Pečeť pro 14denní bezpodmínečnou záruku",
    image: { src: "/guarantee-badge.webp", alt: "Záruka 14 dní" },
  },
    ...
    items: [
      {
        ...
        a: "Ne! Používame běžné suroviny, které už máš nejspíš doma: žádné složité nebo předražené produkty.",
      },
      {
